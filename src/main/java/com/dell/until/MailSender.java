package com.dell.until;

import com.dell.app.MailEntity;
import com.dell.enums.MailContentTypEnum;
...
public class MailSender {
     ...
     * @return
     */
    public MailSender contentType(MailContentTypEnum typeEnum)
    {
        mail.setContentType(typeEnum.getValu());
        return this;
    }
    ...
    public void send() throws Exception
    {
        ...
        if(mail.getContentType() == null)
            mail.setContentType(MailContentTypEnum.HTML.getValu());
        ...
        //html发送邮件
        if(mail.getContentType().equals(MailContentTypEnum.HTML.getValu())) {
            // 设置邮件的内容体
            message.setContent(mail.getContent(), mail.getContentType());
        }
        //文本发送邮件
        else if(mail.getContentType().equals(MailContentTypEnum.TEXT.getValu())){
